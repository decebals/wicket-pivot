 ...
 * @author Decebal Suiu
 */
public class PivotResourcesBehavior extends Behavior {
	...
	public void renderHead(Component component, IHeaderResponse response) {
		...
		PivotSettings settings = PivotSettings.get();
		...
		if (settings.isIncludeBootstrap()) {
			response.render(CssHeaderItem.forReference(settings.getBootstrapCssReference()));
			response.render(JavaScriptHeaderItem.forReference(settings.getBootstrapJavaScriptReference()));
		}
	}
